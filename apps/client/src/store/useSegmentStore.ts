...
interface SegmentState {
  ...
  updateSegmentsBatch: (updates: { id: number; master_value: number }[]) => Promise<void>
...
export const useSegmentStore = create<SegmentState>((set) => ({
    ...
    fetchSegments: async () => {
        ...
        try {
            ...
            console.log("Fetched segments:", res.data) // 👈 Add this
    ...
    updateSegmentsBatch: async (updates: { id: number; master_value: number }[]) => {
        try {
